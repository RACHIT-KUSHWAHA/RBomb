...
banner() {
    ...
    if ! [ -x "$(command -v figlet)" ]; then
        echo 'Introducing RBomb'
    else
        figlet RBomb
    fi
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mRachit \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border Rachit 
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Telegram: https://t.me/II_RACHIT_II \e[0m"
    echo -e "\e[4;32m   YouTube: https://www.youtube.com/c/UNIQUE-DZN \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of RBomb for more stability."
    echo " "
}
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By RACHIT > .update
...
do
    ...
    if [ $ch -eq 1 ];then
        ...
        echo -e "\e[1;34m RUN RBomb Again..."
        pause
        exit
    elif [ $ch -eq 5 ];then
        banner
